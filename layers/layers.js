...
lyr_Data_Persebaran_Penginapan_Fixx_4.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'Nama Hotel': 'Nama Hotel', 'Alamat': 'Alamat', 'Kelurahan': 'Kelurahan', 'Kecamatan': 'Kecamatan', 'Kota': 'Kota', 'Provinsi': 'Provinsi', 'Kode Pos': 'Kode Pos', 'Harga ': 'Harga ', 'Keterangan': 'Keterangan', });
...
lyr_Data_Persebaran_Penginapan_Fixx_4.set('fieldImages', {'X': 'TextEdit', 'Y': 'TextEdit', 'Nama Hotel': 'TextEdit', 'Alamat': 'TextEdit', 'Kelurahan': 'TextEdit', 'Kecamatan': 'TextEdit', 'Kota': 'TextEdit', 'Provinsi': 'TextEdit', 'Kode Pos': 'TextEdit', 'Harga ': 'TextEdit', 'Keterangan': 'TextEdit', });
...
lyr_Data_Persebaran_Penginapan_Fixx_4.set('fieldLabels', {'X': 'no label', 'Y': 'no label', 'Nama Hotel': 'header label - always visible', 'Alamat': 'header label - always visible', 'Kelurahan': 'header label - always visible', 'Kecamatan': 'header label - always visible', 'Kota': 'header label - always visible', 'Provinsi': 'header label - always visible', 'Kode Pos': 'header label - always visible', 'Harga ': 'header label - always visible', 'Keterangan': 'header label - always visible', });
